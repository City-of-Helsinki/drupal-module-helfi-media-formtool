...
namespace Drupal\helfi_media_formtool\Form;
...
class FormToolMediaFormAddForm extends AddFormBase {
  ...
  protected function buildInputElement(array $form, FormStateInterface $form_state) {
    ...
    $container['helfi_media_formtool_url'] = [
      '#type' => 'textfield',
  ...
  public function addButtonSubmit(array $form, FormStateInterface $form_state) {
    $this->processInputValues([$form_state->getValue('helfi_media_formtool_url')], $form, $form_state);
  }
